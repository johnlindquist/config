...
local shortcuts = {
  ...
  { key = "⌘T", desc = "New tab (smart split)", cat = "nav" },
  ...
  -- Panes
  { key = "⌘S", desc = "Toggle pane zoom", cat = "pane" },
  { key = "⌘A", desc = "Equalize all panes into grid", cat = "pane" },
  { key = "⌘D", desc = "Cycle to next pane", cat = "pane" },
  { key = "⌘⇧D", desc = "Cycle to prev pane", cat = "pane" },
  ...
  { key = "⌘⇧P", desc = "Zen mode (hide tabs)", cat = "power" },
  { key = "⌘⇧T", desc = "Theme picker", cat = "power" },
  { key = "⌘⇧R", desc = "Recording mode", cat = "power" },
  ...
  { key = "⌘Z", desc = "Open Zed at cwd", cat = "power" },
  -- Leader (Alt+L)
  { key = "⌥L z", desc = "Zen mode (hide tabs)", cat = "leader" },
  { key = "⌥L s", desc = "Save session (resurrect)", cat = "leader" },
  { key = "⌥L t", desc = "Cycle themes", cat = "leader" },
  { key = "⌥L ⇧T", desc = "Restore auto-theme", cat = "leader" },
  { key = "⌥L ,", desc = "Rename tab", cat = "leader" },
  { key = "⌥L r", desc = "Enter resize mode", cat = "leader" },
  { key = "⌥L [", desc = "Enter copy mode (vim)", cat = "leader" },
  { key = "⌥L hjkl", desc = "Navigate panes", cat = "leader" },
  { key = "⌥L c", desc = "New tab", cat = "leader" },
  { key = "⌥L n/p", desc = "Next/prev tab", cat = "leader" },
  { key = "⌥L 1-5", desc = "Jump to tab by number", cat = "leader" },
}
